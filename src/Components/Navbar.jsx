...
const Navbar = () => {
  return (
    <div className="Navbar">
      <img
        src="https://e7.pngegg.com/pngimages/945/14/png-clipart-web-development-e-commerce-shopping-cart-software-logo-online-shopping-business-web-design-service.png"
        alt=""
      />
